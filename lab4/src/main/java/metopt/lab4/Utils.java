...
public class Utils {
     ...
     */
    public static metopt.lab4.matrices.Vector Gauss(final Matrix A, final metopt.lab4.matrices.Vector B) {
        n = A.size();
        a = new double[n][n];
        for (int i = 0; i < n; ++i) {
            for (int j = 0; j < n; ++j) {
        ...
        return new metopt.lab4.matrices.Vector(b);
    }

    public static metopt.lab4.matrices.Vector GaussLU(final Matrix A, final metopt.lab4.matrices.Vector B) {
    ...
    public static metopt.lab4.matrices.Vector gauss(final Matrix aold, final metopt.lab4.matrices.Vector bold) {
        final FullMatrix a = new FullMatrix(aold);
        final metopt.lab4.matrices.Vector b = new Vector(bold);
        final int n = a.size();
        final metopt.lab4.matrices.Vector ans = new metopt.lab4.matrices.Vector(n);
